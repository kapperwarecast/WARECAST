-- ============================================================================
-- MIGRATION: Fix ownership_history transfer_date NULL constraint
-- Date: 2025-11-17
-- Description: Add transfer metadata (transfer_date, acquisition_date,
--              acquisition_method) to films_registry updates in ÉTAPE 7
--              to prevent NULL constraint violation in ownership_history trigger
-- ============================================================================
...
BEGIN
  ...
  -- =========================================================================
  -- ÉTAPE 7: ÉCHANGE INSTANTANÉ ATOMIQUE (FIX: Ajout metadata transfer)
  -- =========================================================================
  ...
  SET
    ...
    transfer_date = NOW(),          -- FIX: Ajouter date transfert
    acquisition_date = NOW(),       -- FIX: Ajouter date acquisition
    acquisition_method = 'exchange', -- FIX: Ajouter méthode
    updated_at = NOW()
...
-- Commentaire
COMMENT ON FUNCTION rent_or_access_movie IS 'RPC pour créer sessions et gérer échanges instantanés - Fix ownership_history transfer metadata';

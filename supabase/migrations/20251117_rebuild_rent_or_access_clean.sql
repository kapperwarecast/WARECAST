-- ============================================================================
-- MIGRATION: Reconstruction propre du RPC rent_or_access_movie
-- Date: 2025-11-17
-- Description: Version simplifiée et robuste avec corrections:
--   - Schéma film_exchanges correct (initiator_id, recipient_id, etc.)
--   - Rotation de session pour TOUS les utilisateurs
--   - movie_id correct après échange
...
BEGIN
  ...
  -- =========================================================================
  -- ÉTAPE 3: USER NE POSSÈDE PAS → Vérifier disponibilité
  -- =========================================================================
...
-- Commentaire
COMMENT ON FUNCTION rent_or_access_movie IS 'RPC simplifié pour créer sessions et gérer échanges instantanés automatiques';

-- ============================================================================
-- MIGRATION: Fix ownership_history INSERT - Add missing transfer_date
-- Date: 2025-11-24
-- Description: Corrige les INSERT dans rent_or_access_movie qui causent
--              l'erreur "null value in column transfer_date violates not-null constraint"
-- ============================================================================
...
BEGIN
  ...
  -- ✅ FIX: Ajout de transfer_date = NOW()
  INSERT INTO ownership_history (registry_id, from_user_id, to_user_id, transfer_type, transfer_date)
  VALUES (v_registry_id, v_film_owner_id, p_auth_user_id, 'exchange', NOW());

  INSERT INTO ownership_history (registry_id, from_user_id, to_user_id, transfer_type, transfer_date)
  VALUES (v_offered_registry_id, p_auth_user_id, v_film_owner_id, 'exchange', NOW());
...
FIX: Ajout de transfer_date dans INSERT ownership_history.';

-- ============================================================================
-- MIGRATION: Fix rotation pour échanges payants
-- Date: 2025-11-23
-- Description: Permet la rotation automatique AVANT la sélection du film à offrir
--              pour que les utilisateurs payants puissent échanger même s'ils
--              ont une session active sur leur seul film.
--
-- Problème: La rotation se faisait APRÈS la sélection du film, donc si l'utilisateur
--           n'avait qu'un film en session active, la sélection échouait avec NO_FILM_TO_EXCHANGE
--
-- Solution: Déplacer la rotation AVANT la sélection du film à offrir
-- ============================================================================
...
BEGIN
  ...
  -- ============================================================================
  -- ÉTAPE 5: ✅ NOUVEAU - Rotation AVANT sélection du film à offrir
  -- ============================================================================
  -- Fermer toute session active sur un autre film AVANT de chercher un film dispo
  -- Cela permet aux utilisateurs payants (non-abonnés) de faire la rotation aussi
  UPDATE viewing_sessions
  SET statut = 'rendu', updated_at = NOW()
  WHERE user_id = p_auth_user_id
    AND statut = 'en_cours'
  ...
  -- ============================================================================
  -- ÉTAPE 6: Sélectionner automatiquement film de l'user à offrir
  -- ============================================================================
  -- Maintenant que les sessions actives sont fermées, on peut trouver un film dispo
  SELECT fr.id, fr.id
  ...
  -- ============================================================================
  -- ÉTAPE 7: ÉCHANGE INSTANTANÉ (transaction atomique)
  -- ============================================================================
...
CORRECTION APPLIQUÉE (2025-11-23):
- Rotation AVANT sélection du film à offrir (au lieu d''APRÈS)
- Permet aux utilisateurs payants de faire la rotation comme les abonnés';

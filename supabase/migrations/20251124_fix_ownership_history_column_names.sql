-- ============================================================================
-- MIGRATION: Fix ownership_history column names
-- Date: 2025-11-24
-- Description: Corrige les noms de colonnes dans rent_or_access_movie
--              Utilise film_registry_id, from_owner_id, to_owner_id
--              (pas registry_id, from_user_id, to_user_id)
-- ============================================================================
...
BEGIN
  ...
  -- ✅ FIX: Utilisation des BONS noms de colonnes + transfer_date
...
FIX: Noms de colonnes corrects (film_registry_id, from_owner_id, to_owner_id) + transfer_date.';

      ...
      <div className="container mx-auto px-6 py-12">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="grid md:grid-cols-2 gap-8">
            ...
            {/* Section À la carte */}
            <Card className={`bg-zinc-900 transition-colors relative flex flex-col h-full ${
              !hasActiveSubscription
              ...
              <CardHeader className="text-center">
                <CardTitle className="text-2xl mb-4">À la carte</CardTitle>
            ...
            <Card className={`bg-zinc-900 transition-colors relative flex flex-col h-full ${
                ...
                <CardHeader className="text-center">
                  <CardTitle className="text-2xl mb-4">Illimité</CardTitle>
